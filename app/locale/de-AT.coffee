...
#  account:
     ...
     prepaids_title: "Vorbezahlte Leistungen"
     payments: "Zahlungen"
     prepaid_codes: "Prepaid Codes"
     purchased: "Gekauft"
     subscribe_for_gems: "Um Edelsteine abonnieren"
     subscription: "Abonnement"
     invoices: "Rechnungen"
     service_apple: "Apple"
     service_web: "Internet"
     paid_on: "Gezahltes aktiviert"
     service: "Service"
     price: "Preis"
     gems: "Edelsteine"
     active: "Aktiv"
     ...
     card: "Karte"
     status_unsubscribed_active: "Du hast nicht abonniert uns es wird auch nichts in Rechnung gestellt, aber dein Account ist weiterhin aktiv."
     status_unsubscribed: "Erhalte mit einem CodeCombat Abonnement neue Level, Helden, Gegenstände und zusätzliche Edelsteine!"
     not_yet_verified: "Noch nicht verifiziert."
     resend_email: "E-Mail erneut versenden"
     email_sent: "Die E-Mail wurde verschickt! Überprüfe deinen Posteingang."
     verifying_email: "Deine E-Mail-Adresse wird verifiziert."
     successfully_verified: "Du hast deine E-Mail-Adresse erfolgreich verifiziert."
     verify_error: "Beim Verifizieren deiner E-Mail-Adresse ist leider etwas schiefgelaufen."
     unsubscribe_from_marketing: "Willst du __email__ von allen CodeCombat Marketing-Mails abmelden?"
     unsubscribe_button: "Ja, abmelden"
     unsubscribe_failed: "Fehlgeschlagen"
     unsubscribe_success: "Dies war erfolgreich."

#  account_invoices:
     amount: "Betrag in US-Dollar"
     declined: "Deine Karte wurde abgelehnt."
     invalid_amount: "Bitte füge einen korrekten Betrag in US-Dollar ein."
     not_logged_in: "Logge dich ein oder erstelle einen Account, um Zugriff auf deine Rechnungen zu bekommen."
     pay: "Zahle die Rechnung"
     purchasing: "Der Kauf wird getätigt."
    retrying: "Es gibt momentan einen Serverfehler, wir versuchen es erneut."
    success: "Du hast erfolgreich bezahlt. Danke!"

#  account_prepaid:
    purchase_code: "Kaufe einen Abonnement-Code"
    purchase_code1: "Du kannst Abonnement-Codes verwenden, um einem oder mehreren CodeCombat Accounts der Home-Version Abonnement-Zeit hinzuzufügen."
    purchase_code2: "Ein bestimmter Abonnement-Code kann pro Account nur einmal eingelöst werden."
    purchase_code3: "Abonnement-Codes werden ans Ende jedes bereits bestehenden Abonnements eines Accounts angehängt."
    purchase_code4: "Abonnement-Codes sind nur für Spieler der Home-Version von CodeCombat verfügbar, Nutzer der Klassenraum-Version können diese nicht anstatt einer Schülerlizenz nutzen."
    purchase_code5: "Wenn du mehr Informationen zu Schülerlizenzen benötigst, begib dich zu "
    users: "Nutzer"
    months: "Monate"
    purchase_total: "Summe"
    purchase_button: "Kauf absenden"
    your_codes: "Deine Codes"
    redeem_codes: "Löse einen Abonnement-Code ein"
    prepaid_code: "Prepaid Code"
    lookup_code: "Suche nach einem Prepaid Code"
    apply_account: "Bei deinem Account anwenden"
    copy_link: "Du kannst den Link des Codes kopieren und an jemanden versenden."
    quantity: "Anzahl"
    redeemed: "Eingelöst"
    no_codes: "Noch keine Codes vorhanden."
    you_can1: "Du kannst"
    you_can2: "einen Prepaid Code kaufen"
    you_can3: "welcher an deinem Account angewendet oder an andere Benutzer weitergegeben werden kann."
